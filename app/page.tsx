          ...
          <div className="mt-4 border border-slate-200 rounded-md p-4 bg-white">
            <div className="flex items-center justify-between mb-3">
              ...
              <PdfDownloadButton
                ...
                contactInfo={contactInfo || { fullName: "", email: "", phone: "", linkedin: "", location: "" }}
                disabled={loading}
              />
            </div>
            ...
            {contactInfo && (contactInfo.fullName || contactInfo.email || contactInfo.phone) && (
              <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-md">
                <p className="text-xs text-blue-600 font-semibold mb-1">Contact info extracted from your resume:</p>
                ...
                {contactInfo.linkedin && <p className="text-xs text-blue-600">{contactInfo.linkedin}</p>}
              </div>
            )}
